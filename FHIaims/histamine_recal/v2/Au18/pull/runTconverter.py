...
with open ("runT.sh", "rt") as myfile:
    for myline in myfile:
        ...
        substra = "ACTIVE=/projectnb/kamenet/xiaoyun/FHIaims/histamine_recal/v2/Au18/pull/"
        #print(myline)
    ...
    for myline in mylines:
        linenum += 1
        if linenum == endindex:
            mydata.append("ACTIVE=/projectnb/kamenet/xiaoyun/FHIaims/histamine_recal/v2/Au18/pull/step%s" % stepnum) 
        else:
